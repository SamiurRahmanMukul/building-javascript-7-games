document.addEventListener("DOMContentLoaded", () => {
  ...
  for (var i = 0; i < len; i++) {
    ...
    // check the board for a win of lose
    function checkBoard() {
      ...
      for (let y = 0; y < winningArrays.length; y++) {
        ...
        // new check those arrays to see if they all have the class of player-one
        if (
          ...
          // if they do, player-one is passed on as the winner
